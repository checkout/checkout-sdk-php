...
namespace Checkout\Tests\Risk\Four;
...
class RiskIntegrationTest extends SandboxTestFixture
{
    ...
    public function shouldPreCaptureAndAuthenticateId()
    {
        ...
        $cardToken = $this->fourApi->getTokensClient()->requestCardToken($cardTokenRequest);
        ...
        $instrumentsResponse = $this->fourApi->getInstrumentsClient()->create($createInstrumentRequest);
